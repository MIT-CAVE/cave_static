      ...
      examplePane: {
        ...
        props: {
          ...
          numericInputExampleAlt: {
            ...
            minValue: 0,
            label:
              'This label is intentionally long to demonstrate how text is truncated when it exceeds the available space.',
            marqueeLabel: false,
            maxValue: 1073741824,
...
const generalPropsAllStories = {
  title: 'Workspaces/GeneralPropsAll',
  component: App,
  parameters: {
    initData,
    layout: 'fullscreen',
...
export default generalPropsAllStories
